                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            ...
                            @endphp
                            <img src="{{ asset('upload/products/'.$image[0]) }}" alt="{{ $product->product_name }}" />
                        </div>
                              ...
                              <!-- Wrapper for slides -->
                                <div class="carousel-inner">
                                    <div class="item active">
                                        ...
                                        <a href="#"><img width="85" height="85" src="{{ asset('upload/products/'.$image[$key]) }}" alt="{{ $product->product_name }}"></a>
                                        @endforeach                                    
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <div>
                                ...
                                <p>شناسـه : {{ $product->code }}</p>
                            </div>
                            <div>
                                <span>
                                    <span>قیمت : {{ $product->selling_price }} تومان</span>
                                </span>
                                <span>
                                    <label>تعداد :</label>
                            ...
                            <div>
                                ...
                                <p><b>برنـد :</b> {{ $product->brand->name }} </p>
                            </div>
                            <span  class="socials-share share">
                                <ul>
                                    <a href="#">
                                        <li>
                                            <label>بلـه</label>
                                            <img src="/images/product-details/Bale.png"/>
                                        </li>
                                    </a>
                                    <a href="#">
                                        <li>
                                            <label>سـروش</label>
                                            <img src="/images/product-details/Soroush.png"/>
                                        </li>
                                    </a>
                                    <a href="#">
                                        <li>
                                            <label>اینستاگرام</label>
                                            <img src="/images/product-details/Instagram.png"/>
                                        </li>
                                    </a>
                                    <li><img src="/images/product-details/rating.png" alt="" /></li>
                                </ul>
                            </span>
