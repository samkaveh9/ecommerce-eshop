        ...
        <section class="col-lg-10 col-lg-offset-1" style="margin-top: 4rem">
            <div class="box">
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{ route('sitesetting.store') }}" method="post"
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="first_phonenumber"
                                               id="first_phonenumber" placeholder="تلفن اول شرکت را وارد کنید...">
                                    </div>
                                    <div class="col-xs-6">
                                        <label for="second_phonenumber">تلفن دوم شرکت</label>
                                        <input type="text" class="form-control" name="second_phonenumber"
