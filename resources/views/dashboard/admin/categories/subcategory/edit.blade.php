        ...
        <section class="col-lg-10 col-lg-offset-1" style="margin-top: 4rem">
            <div class="box">
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{ route('subcategories.update',$subcategory->slug) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            <div class="form-group">
                                <label for="name">نام زیر دسته</label>
                            <input type="text" class="form-control" name="name" id="name" value="{{ $subcategory->name }}" placeholder="نام زیر دسته را وارد کنید...">
                            </div>
                        </div>
