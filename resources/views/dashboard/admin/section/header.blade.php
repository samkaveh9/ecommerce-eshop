      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <li>
                <a href="{{route('password.change')}}"><i class="fa fa-fw fa-user-secret"></i> تغییر رمز عبور</a>
            </li>
            <li>
            ...
            <li>
                <form action="{{ route('logout') }}" method="POST">
                  @csrf
                  <button type="submit" style="display: inline-block;background-color: transparent;border: none; padding: 3px 20px;white-space: nowrap;line-height: 1.42857143;color:#777"><i class="fa fa-fw fa-power-off"></i> خروج</button>
                </form>
            </li>
            </ul>
          </li>
